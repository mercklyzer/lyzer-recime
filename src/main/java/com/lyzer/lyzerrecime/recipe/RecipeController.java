...
public class RecipeController {
    ...
    @PutMapping("/{id}")
    public RecipeResponse replaceRecipe(
            @PathVariable Long id, @Valid @RequestBody UpdateRecipeRequest request) {

        // Full replacement, not a merge: the body carries the whole recipe,
        // ingredients included. No PATCH.
